...
class ComputersPage(tkinter.Frame):
    ...
    def populate_window(self, controller):
        ...
        query = 'SELECT TU_Tag_Number, Computer_Type, Current_Location, Cost FROM Computer'

        self.create_header(controller, 'All computers')
