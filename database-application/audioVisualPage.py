...
class AudioVisualPage(tkinter.Frame):
    ...
    def populate_window(self, controller):
        """ 
            ...
            - controller : the application
        """
        # Query: Get all A/V equipment
        query = 'SELECT Serial_Number, Model_Number, TU_Tag_Number, Office_Location FROM Audio_Visual_Eq'

        self.create_header(controller, 'All Audio/Visual (A/V) equipment')
