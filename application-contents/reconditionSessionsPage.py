...
class ReconditionSessionsPage(tkinter.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.results_table = ttk.Treeview(self, column=('1', '2', '3', '4', '5', '6')) # table to store results from query
    ...
    def populate_window(self, controller):
        """ 
            ...
            - controller : the application
        """
        # Query: Get all reconditioning sessions
        query = 'SELECT * FROM Reconditioning_session'
        self.create_header(controller, 'All reconditioning sessions')
